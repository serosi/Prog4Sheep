...
GreenBalloon::GreenBalloon(int startX, int startY, wxPanel* drawingPanel, wxStaticText* scoreValue)
...
int GreenBalloon::popScore() {
	return 20;
}

//This method returns the type of the object
int GreenBalloon::typeOfObject() {
	return type;
}